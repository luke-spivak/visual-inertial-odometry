...
docs/development-log.md calls camera timestamping the highest-risk item in this build, and
...
Three things it reports, in descending order of importance:
  ...
  3. DELIVERY LATENCY -- SensorTimestamp against the monotonic clock read the
     ...
     arrival, which is what UVC forces and is precisely why docs/development-log.md chose
...
def main():
    ...
    # processed path returns zeros (see docs/development-log.md, Camera bringup). `main` is
