...
def main():
    ...
    # purely as scene-graph load. See docs/development-log.md "Real-time factor is a budget".
...
<!-- GENERATED by sim/gazebo/worlds/make_ground.py; do not hand-edit.
...
<model>
  ...
  <description>
    ...
    camera's ground sample distance. Generated by sim/gazebo/worlds/make_ground.py.
  </description>
</model>
""")
