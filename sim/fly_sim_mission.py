...
(see docs/development-log.md "Validated baseline") that comparing different flights is
meaningless.
...
def main():
    ...
    if args.speed > 0:
        ...
        # 8.15 m/s. docs/development-log.md's inter-frame motion figures were derived from an
